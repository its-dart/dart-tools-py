...
T = TypeVar("T", bound="TaskDescriptionUpdate")


@_attrs_define
class TaskDescriptionUpdate:
    """Payload for applying a list of targeted text updates to a task's description.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_description_update = cls(
            updates=updates,
        )

        task_description_update.additional_properties = d
        return task_description_update
