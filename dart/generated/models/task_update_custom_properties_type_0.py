...
T = TypeVar("T", bound="TaskUpdateCustomPropertiesType0")
...
class TaskUpdateCustomPropertiesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        task_update_custom_properties_type_0 = cls()
        ...
        task_update_custom_properties_type_0.additional_properties = additional_properties
        return task_update_custom_properties_type_0
