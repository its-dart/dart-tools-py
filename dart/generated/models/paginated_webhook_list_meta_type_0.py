...
if TYPE_CHECKING:
    from ..models.paginated_webhook_list_meta_type_0_applied_default_filters import (
        PaginatedWebhookListMetaType0AppliedDefaultFilters,
    )


T = TypeVar("T", bound="PaginatedWebhookListMetaType0")


@_attrs_define
class PaginatedWebhookListMetaType0:
    """
    Attributes:
        defaults_applied (Union[Unset, bool]): Whether default filters or ordering were applied to the response.
        applied_default_filters (Union[Unset, PaginatedWebhookListMetaType0AppliedDefaultFilters]): The default filters
    ...
    applied_default_filters: Union[Unset, "PaginatedWebhookListMetaType0AppliedDefaultFilters"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        applied_default_filters: Union[Unset, PaginatedWebhookListMetaType0AppliedDefaultFilters]
        if isinstance(_applied_default_filters, Unset):
            applied_default_filters = UNSET
        else:
            applied_default_filters = PaginatedWebhookListMetaType0AppliedDefaultFilters.from_dict(
        ...
        paginated_webhook_list_meta_type_0 = cls(
        ...
        paginated_webhook_list_meta_type_0.additional_properties = d
        return paginated_webhook_list_meta_type_0
