...
T = TypeVar("T", bound="TaskCustomPropertiesType0")


@_attrs_define
class TaskCustomPropertiesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        task_custom_properties_type_0 = cls()
        ...
        task_custom_properties_type_0.additional_properties = additional_properties
        return task_custom_properties_type_0
